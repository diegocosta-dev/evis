export const RenderBlocks = ({ blocks }) => {
  return blocks.map((block) => {
    ...
    switch (type) {
      ...
      case 'video':
        const videoUrl = _getYoutubeUrl(value.external.url) ?? _getVimeoUrl(value.external.url)
        ...
        if (videoUrl) {
          ...
          <div>Only suport youtube or vimeo urls</div>
        }
